...
public abstract class DataSourceUtils {
	...
	public static Connection getConnection(DataSource dataSource) throws CannotGetJdbcConnectionException {
		try {
			return doGetConnection(dataSource);//获得数据库连接
		}
...
//TransactionSynchronizationManager中的ThreadLocal存储了key为dataSource，value为ConnectionHolder的map，这里取出ConnectionHolder
		...
		if (TransactionSynchronizationManager.isSynchronizationActive()) {
			...
			if (holderToUse != conHolder) {//添加到ThreadLocal的map中
